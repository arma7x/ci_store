...
// CONFIG BEGIN HERE
$DATABASE_URL = 'mysqli://root:root@localhost/ci_store';
...
*/
$config['composer_autoload'] = realpath(dirname(BASEPATH).'/vendor/autoload.php');
...
$config['sess_save_path'] = APPPATH.'_sessions';
