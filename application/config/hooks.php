...
$hook['post_controller_constructor'][] = function() {
	...
	$CI->load->model('Essential_Information_Model', 'EI');
	$CI->load->model('General_Information_Model', 'GI');
	$CI->load->model('Social_Channel_Model', 'SC');
	$CI->load->model('Inbox_Channel_Model', 'IC');
	$CI->container['ei_link'] = $CI->EI->get_all_cache();
	$CI->container['gi_link'] = $CI->GI->get_all_cache();
