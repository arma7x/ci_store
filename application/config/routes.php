...
$route['src/ic.js']['get'] = 'src/ic';
$route['src/sc.js']['get'] = 'src/sc';
$route['src/category.js']['get'] = 'src/category';
$route['sw.js']['get'] = 'src/sw';
$route['manifest.json']['get'] = 'src/manifest';
$route['product']['get'] = 'product/view';
$route['product/(:any)']['get'] = 'product/search';
