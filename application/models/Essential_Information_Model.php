...
class Essential_Information_Model extends MY_Model {
	...
	public static $PUBLIC_VIEW_FIELD = 'slug, title, position, visibility, material_icon, brief_description, full_description, updated_at';
	public static $PUBLIC_FIELD = 'title, slug, position, material_icon';
	public static $CACHE_PREFIX = 'EI_';
	public static $ALL_CACHE = 'CACHE_SLUG';
