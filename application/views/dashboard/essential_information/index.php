...
<div class="container starter-template">
	...
	<div class="col col-12">
		...
		<div class="row mb-1">
			<button type="button" class="btn btn-sm btn-success mb-1" data-toggle="modal" data-target="#addModal">
						...
						<tr>
							...
							<td style="width:150px;">
								<form class="mb-2">
									...
									<button class="btn btn-block btn-sm btn-primary" onclick="updateOrderEI('<?php echo $item['id'] ;?>', '<?php echo $item['title'] ;?>')">
								...
								<form>
									...
									<button class="btn btn-block btn-sm btn-primary" onclick="updateIconEI('<?php echo $item['id'] ;?>', '<?php echo $item['title'] ;?>')">
										<?php echo lang('BTN_EDIT') ?>
									</button>
								</form>
							</td>
							<td style="width:150px;">
								<form class="mb-2">
									...
									<button class="btn btn-block btn-sm btn-primary" onclick="updatePositionEI('<?php echo $item['id'] ;?>', '<?php echo $item['title'] ;?>')">
										<?php echo lang('BTN_EDIT') ?>
									</button>
								</form>
								<form>
									...
									<button class="btn btn-block btn-sm btn-primary" onclick="updateVisibilityEI('<?php echo $item['id'] ;?>', '<?php echo $item['title'] ;?>')">
										<?php echo lang('BTN_EDIT') ?>
									</button>
								</form>
							</td>
