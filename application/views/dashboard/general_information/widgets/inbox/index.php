...
<div class="mt-3">
	<div class="row">
		<div class="col col-12">
			<button type="button" class="btn btn-sm btn-success mb-1" data-toggle="modal" data-target="#addInboxModal">
							...
							<td style="width:150px;">
								<form>
									...
									<div class="col col-12 p-0">
										<button class="btn btn-block btn-sm btn-primary" onclick="updateOrderInboxChannel('<?php echo $item['id'] ;?>', '<?php echo $item['name'] ;?>')">
