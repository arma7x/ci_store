                    ...
                    <a class="dropdown-item p-3<?php echo $this->uri->segment(1) == 'product' ? ' text-primary active' : ''?>" onclick="navigate('/product')"><i class="material-icons">&#xe8d1;</i> <?php echo 'Store';?></a>
                      ...
                      <div class="dropdown-item p-3<?php echo $this->uri->segment(2) == 'ui_update_password' || $this->uri->segment(2) == 'manage_token' ? ' active' : ''?>">
                        <div id="heading_profile" data-toggle="collapse" data-target="#collapse_profile" aria-expanded="false" aria-controls="collapse_profile">
                            <i class="material-icons">&#xe853;</i> <?php echo lang('H_PROFILE') ?>
                      ...
                      <?php endif; ?>
                      <?php if($this->container['user'] === NULL): ?>
                        <a class="dropdown-item p-3<?php echo '/'.$this->uri->uri_string() == '/authentication/ui_login' ? ' text-primary active' : ''?>" onclick="navigate('/authentication/ui_login')"><i class="material-icons">&#xe879;</i> <?php echo lang('H_LOGIN');?></a>
                        <?php if(APP_REGISTRATION === TRUE): ?>
                        <a class="dropdown-item p-3<?php echo '/'.$this->uri->uri_string() == '/authentication/ui_register' ? ' text-primary active' : ''?>" onclick="navigate('/authentication/ui_register')"><i class="material-icons">&#xe7fe;</i> <?php echo lang('H_REGISTER');?></a>
                      ...
                      <?php if($this->container['user'] !== NULL): ?>
                        ...
                        <a class="dropdown-item p-3 text-primary font-weight-bold" onclick="navigate('/dashboard')"><i class="material-icons">&#xe30d;</i> <?php echo lang('H_DASHBOARD');?></a>
                        <?php endif; ?>
                      <?php endif; ?>
                      ...
                      <?php if($this->container['user'] !== NULL): ?>
                        <a class="dropdown-item p-3" onclick="logout()"data-turbolinks="false"><i class="material-icons">&#xe879;</i> <?php echo lang('H_LOGOUT');?></a>
                      <?php endif; ?>
                    </div>
                    </div>
                </div>
