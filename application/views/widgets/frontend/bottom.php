...
<div class="bg-white">
	...
	<button type="button" class="btn btn-dark btn-circle dropup shadow-sm mr-auto ml-3 mb-3 fixed-bottom d-none d-lg-block d-xl-block" data-toggle="modal" data-target="#ic-modal" data-placement="top" title="<?php echo lang('H_G_INBOX_CHANNEL') ;?>" style="z-index:99!important;"><i class="material-icons mi_fab">&#xe0e1;</i></button>
